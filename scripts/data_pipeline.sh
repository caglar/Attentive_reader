...
MODE="train"
QVOCAB=q_vocab_${NEWS_SOURCE}_${MODE}.pkl
AVOCAB=a_vocab_${NEWS_SOURCE}_${MODE}.pkl
DVOCAB=d_vocab_${NEWS_SOURCE}_${MODE}.pkl
...
python -m ipdb create_h5_files.py --input_dir ${TEST_SOURCE_PATH} --vocab_desc ${DVOCAB} --vocab_ans ${AVOCAB} --vocab_q ${QVOCAB} --output_file ${TOUT_FILE}
